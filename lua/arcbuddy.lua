...
Group.new('IncSearch',    c.syntax_bg,    c.hue_6,         no)
Group.new('LineNr',       c.mono_4,       c.none,          no)
Group.new('CursorLineNr', c.mono_1,       c.syntax_bg,     no)
...
Group.new('TabLine',      c.mono_2,       c.syntax_gutter, no)
Group.new('TabLineFill',  c.mono_3,       c.syntax_gutter, no)
Group.new('TabLineSel',   c.mono_3,       c.syntax_bg,     no)
...
-- PHP
Group.new('phpVarSelector',    c.hue_5,   c.none, no)
Group.new('phpOperator',       c.mono_1,  c.none, no)
Group.new('phpParent',         c.mono_1,  c.none, no)
Group.new('phpMemberSelector', c.mono_1,  c.none, no)
Group.new('phpType',           c.hue_3,   c.none, no)
Group.new('phpKeyword',        c.hue_3,   c.none, no)
Group.new('phpClass',          c.hue_6_2, c.none, no)
Group.new('phpUseClass',       c.mono_1,  c.none, no)
Group.new('phpUseAlias',       c.mono_1,  c.none, no)
Group.new('phpInclude',        c.hue_3,   c.none, no)
Group.new('phpClassExtends',   c.hue_4,   c.none, no)
Group.new('phpDocTags',        c.mono_1,  c.none, no)
Group.new('phpFunction',       c.hue_2,   c.none, no)
Group.new('phpFunctions',      c.hue_1,   c.none, no)
Group.new('phpMethodsVar',     c.hue_6,   c.none, no)
Group.new('phpMagicConstants', c.hue_6,   c.none, no)
Group.new('phpSuperglobals',   c.hue_5,   c.none, no)
Group.new('phpConstants',      c.hue_6,   c.none, no)
...
Group.new('BufferCurrent',        c.mono_1,       c.syntax_bg,     no)
Group.new('BufferCurrentMod',     c.hue_4,        c.syntax_bg,     no)
Group.new('BufferCurrentSign',    c.hue_1,        c.syntax_bg,     no)
Group.new('BufferCurrentTarget',  c.hue_5,        c.syntax_bg,     b)
Group.new('BufferVisible',        c.mono_1,       c.syntax_gutter, no)
Group.new('BufferVisibleMod',     c.hue_4:dark(), c.syntax_gutter, no)
Group.new('BufferVisibleSign',    c.vertsplit,    c.syntax_gutter, no)
Group.new('BufferVisibleTarget',  c.hue_5:dark(), c.syntax_gutter, b)
Group.new('BufferInactive',       c.mono_4,       c.syntax_gutter, no)
Group.new('BufferInactiveMod',    c.hue_4:dark(), c.syntax_gutter, no)
Group.new('BufferInactiveSign',   c.vertsplit,    c.syntax_gutter, no)
Group.new('BufferInactiveTarget', c.hue_5:dark(), c.syntax_gutter, b)
...
Group.new('TSConditional',        c.hue_3_2, c.none, no)
Group.new('TSConstant',           c.hue_6,   c.none, no)
...
Group.new('TSError',              c.hue_5_2, c.none, no)
Group.new('TSException',          c.hue_3_2, c.none, no)
...
Group.new('TSInclude',            c.hue_3,   c.none, no)
Group.new('TSKeyword',            c.hue_5,   c.none, no)
Group.new('TSKeywordFunction',    c.hue_3,   c.none, no)
Group.new('TSKeywordOperator',    c.hue_3,   c.none, no)
Group.new('TSLabel',              c.hue_2,   c.none, no)
Group.new('TSLiteral',            c.hue_6_2, c.none, no)
Group.new('TSMethod',             c.hue_2,   c.none, no)
Group.new('TSNamespace',          c.hue_3_2, c.none, no)
...
Group.new('TSRepeat',             c.hue_3_2, c.none, no)
...
Group.new('TSType',               c.hue_3,   c.none, no)
Group.new('TSTypeBuiltin',        c.hue_3_2, c.none, no)
...
Group.new('LspDiagnosticsDefaultError',        c.hue_5:light(),              c.none,  no)
...
Group.new('LspDiagnosticsDefaultWarning',        c.hue_6_2:light(),              c.none,  no)
...
Group.new('LspDiagnosticsDefaultInformation',        c.hue_1:light(),                    c.none,  no)
...
Group.new('LspDiagnosticsDefaultHint',        c.mono_1:light(),            c.none,  no)
